...
//        button1.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        ...
        let myTmeplatebutton = TemplateButton(buttonLabel: "Mybutton")
        view.addSubview(myTmeplatebutton)

        // 3. Add constraints.
        myTmeplatebutton.translatesAutoresizingMaskIntoConstraints = false
        myTmeplatebutton.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        myTmeplatebutton.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
    }
